...
/**
 * This controller manages everything related to the registration of the users (autogenerated by Symfony)
 * Only the file upload code structure was added (and it is explained in ProfileController*)
 */
